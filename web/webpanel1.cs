   ...
   public class webpanel1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB080( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttParametro_Internalname, "", "Parametro", bttParametro_Jsonclick, 5, "Parametro", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'PARAMETRO\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WebPanel1.htm");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'PARAMETRO'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'Parametro' */
                              E11082 ();
                           }
      ...
      protected void E11082( )
      {
         /* 'Parametro' Routine */
         returnInSub = false;
         AV5WebSession.Set("NOME", "Marcelo Vicente de Sousa");
         CallWebObject(formatLink("webpanel2.aspx", new object[] {UrlEncode(StringUtil.RTrim("NOME TESTE"))}, new string[] {"Nome"}) );
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("webpanel1.js", "?20217221754477", false, true);
      ...
      {
         bttParametro_Internalname = "PARAMETRO";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'PARAMETRO'","{handler:'E11082',iparms:[]");
         setEventMetadata("'PARAMETRO'",",oparms:[]}");
         return  ;
      }
      ...
      private string bttParametro_Internalname ;
      private string bttParametro_Jsonclick ;
      private string sEvt ;
